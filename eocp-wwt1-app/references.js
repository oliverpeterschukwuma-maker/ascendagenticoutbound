...
},
{
  ...
  items:[
    ...
    {n:'EOCP Resources hub',
     o:'Environmental Operators Certification Program', y:'Current', src:'OFFICIAL',
     w:'EOCP\'s central resources page — webinars, guidance documents and operator tools. Start here when you want to know what EOCP itself publishes rather than relying on third parties.',
     u:'https://eocp.ca/resources/'},
    {n:'EOCP Facility Classification',
     o:'Environmental Operators Certification Program', y:'Current', src:'OFFICIAL',
     w:'Explains how BC and Yukon facilities are classified using a points-based model, following the Canadian Water and Wastewater Operator Certification Committee best practices and ABC. Facility classification sets the operator certification level a plant requires — a Level I exam topic and directly relevant to your own job.',
     u:'https://eocp.ca/facilities/facility-classification/'},
    {n:'EOCP Wastewater Treatment 1 course',
     o:'Environmental Operators Certification Program', y:'Current', src:'OFFICIAL',
     w:'EOCP\'s own introductory Wastewater Treatment 1 training: plant components and treatment methods across varying complexity. The closest thing to a course written by the people who certify you, and it earns CEUs.',
     u:'https://eocp.ca/event/wastewater-treatment-1/'},
    {n:'EOCP OIT (Operator-in-Training) Sample Exam',
     o:'Environmental Operators Certification Program', y:'2020 edition', src:'OFFICIAL',
     w:'A second published EOCP sample exam. Like the SWWS paper it is not a Level I exam, but it shows EOCP question phrasing and the practical, duty-focused style they favour.',
     u:'https://eocp.ca/wp-content/uploads/2021/01/OIT-Sample-Exam-2020-December.pdf'},
    {n:'EOCP CEU Allocation Table',
     o:'Environmental Operators Certification Program', y:'Current', src:'OFFICIAL',
     w:'How training and activities convert into CEUs. Useful the moment you are certified, so you bank credits from year one instead of scrambling at renewal.',
     u:'https://eocp.ca/wp-content/uploads/2012/10/CEUAllocationTable1.pdf'},
    {n:'EOCP Program Guide',
     o:'Environmental Operators Certification Program', y:'Current', src:'OFFICIAL',
     w:'The governing document for certification: application, classification, exams, renewal and operator obligations. Dry, but it is the authority when a question about process or eligibility comes up.',
     u:'https://eocp.ca/about-us/program-guide/'},
    {n:'EOCP Sample Exams (Small Wastewater Systems and Operator-in-Training)',
     o:'Environmental Operators Certification Program', y:'2020 edition', src:'OFFICIAL',
     w:'EOCP publishes sample exams, but NOT one for Wastewater Treatment Level I — the published papers are Small Wastewater Systems (SWWS), Operator-in-Training (OIT), Small Water Systems (SWS) and Basic Water Distribution (BWD). Use the SWWS paper for EOCP question STYLE, not Level I content. Their style is notably practical and duty-focused: standby equipment testing, chemical stock, settling basin cleaning and judging sludge by colour and odour. This app now includes questions in that style.',
