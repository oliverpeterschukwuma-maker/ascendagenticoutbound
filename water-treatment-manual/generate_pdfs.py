#!/usr/bin/env python3
"""Regenerate WATER_TREATMENT_MANUAL.pdf and LOGBOOK.pdf from their markdown sources.

Usage: python3 generate_pdfs.py

Does NOT touch CHEMICAL_MIXING_GUIDE.pdf — that one is photo-illustrated and has
no markdown source in this repo, so it can't be regenerated by this script.
"""
import os
import markdown
...
if __name__ == "__main__":
    build_manual()
    build_logbook()
    print("Skipped CHEMICAL_MIXING_GUIDE.pdf — no markdown source in this repo, can't be regenerated here.")
