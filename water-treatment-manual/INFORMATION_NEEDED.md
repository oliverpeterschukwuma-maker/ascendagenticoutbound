...
- [ ] **Sand filter (SRS-SF-11) is broken** — a former operator confirmed it needs repair or replacement. Find out: is this already known to current supervisor/SUMAS? Is a repair/replacement scheduled? Until fixed, the bag filter is carrying extra load it wasn't designed for — ask if discharge water quality is being checked more closely in the meantime.
