...
- [ ] **⚠️ Ozone reading 0% — likely lead identified, not yet confirmed on-site:** If the AERQUS flow meter ball is at/near 0 SCFH, no oxygen reaches the CD30TIX, which would explain the 0% ozone reading. Still need: actual float ball position checked on-site, and whether turning the −/+ knob up changes the downstream ozone % reading. (See Section 6.7.)
