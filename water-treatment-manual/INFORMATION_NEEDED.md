...
- [x] **Lime conditional vs. every-time — RESOLVED BY SUPERVISOR (Brendan, text):** "Lime you only need to use if the pH is too low. If it's too low sometimes the chemicals won't work." Confirms conditional-on-pH, not a fixed every-batch step (see Section 5.6a). Still need: exact dose/ratio of lime, SDS, PPE.
...
- [ ] **⚠️ NEW — Ozone reading 0%:** Operator asked Brendan how to get the ozone working, reported it reads 0%. Brendan described a manual adjustment dial ("turn to increase or decrease the amount") but didn't say what 0% means or whether it's a problem. Need: is 0% a live output reading (not generating) or an unset dial? Which unit — CD30TIX cabinet or AERQUS diffuser — has the dial and the 0% display? (See Section 6.7.)
