...
- [x] **Sequence after ozone — RESOLVED, CONFIRMED BY OPERATOR:** ozone-fed water (via the "down" pipe) lands in the indoor settling bins/wet cell to settle further, then a submersible pump pushes it out (via the "up" pipe) to the bag filter and carbon vessel (see Section 6.2a, 6.7). Still pending: photo to confirm exact physical identification of the two pipes.
