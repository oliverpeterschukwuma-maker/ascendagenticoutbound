...
- [x] **Discharge permit — RESOLVED, CONFIRMED BY SUPERVISOR (Brendan):** Site has **NO permit to discharge to the drain.** This is why treated water is trucked/transferred to a lagoon instead of a permitted outfall — not a gap in this manual, that's just how this site operates. Still need: is the lagoon itself authorized/permitted in any way? Who owns/manages it?
...
- [ ] **Permit exceedance reporting** — now likely moot for a drain discharge (there is none), but still relevant if the lagoon itself has any reporting requirements — confirm with supervisor or SUMAS.
...
- [x] **Lime chemical identity — RESOLVED, CONFIRMED BY SUPERVISOR (Brendan, text message):** It's quicklime (calcium oxide, CaO), not hydrated lime as the photographed bag label (IMG_2803, "TEXLOME High Calcium Hydrated Lime") suggested — supervisor's direct word overrides the label. "The bag we should have around and it just says lime." Quicklime reacts exothermically (releases heat) when wetted — bigger handling hazard than hydrated lime would have been. PPE/SDS specifics still pending (see Section 5.6a).
